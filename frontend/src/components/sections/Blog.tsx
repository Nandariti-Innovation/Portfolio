...
export const Blog = () => {
  ...
  return <section className="panel content-panel" id="blog">
    <SectionHeader index={heading?.index || "04"} eyebrow={heading?.eyebrow || "FIELD NOTES"} title={heading?.title || "Writing from inside the build."} />
    <div className="post-list">
      {blogs.map((post) => <article key={post.id}>
